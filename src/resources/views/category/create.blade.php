...
@section('content')
    ...
    <form method="post" action="{{ route('broker.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="ibox">
            ...
            <div class="ibox-footer">
                ...
                <a href="{{ route('broker.index') }}" class="btn btn-default"> <i class="fa fa-arrow-left"></i> Back</a>
            </div>
        </div>
    </form>
    </div>
