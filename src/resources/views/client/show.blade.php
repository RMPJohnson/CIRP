                ...
                <div class="container mt-4">
                    <div class="row">
                            ...
                            <div class="profile-info">
                                <h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="row mt-2">
                                                <div class="col-lg-6"><dt>Created At:</dt></div>
                                                <div class="col-lg-6">{{ date(env("DATE_FORMAT"),strtotime($user->profile->created_at)) }}</div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-lg-6"><dt>Updated At:</dt></div>
                                                <div class="col-lg-6">{{ date(env("DATE_FORMAT"),strtotime($user->profile->updated_at)) }}</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="row mt-2">
                                                <div class="col-lg-6"><dt>Created By:</dt></div>
                                                <div class="col-lg-6">{{ $user->profile->created_by->name }}</div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-lg-6"><dt>Updated By:</dt></div>
                                                <div class="col-lg-6">{{ $user->profile->updated_by->name }}</div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <h3>
                                <div class="row mt-2">
                                    <div class="col-lg-6"><dt>Agents:</dt></div>
                                    <div class="col-lg-6">40</div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-6"><dt>Clients:</dt></div>
                                    <div class="col-lg-6">56</div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-6"><dt>Projects:</dt></div>
                                    <div class="col-lg-6">32</div>
                                </div>
                            </h3>
                        </div>
                    </div>
